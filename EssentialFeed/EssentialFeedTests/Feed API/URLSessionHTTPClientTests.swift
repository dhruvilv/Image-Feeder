...
//  EssentialFeedTests
//
//  Created by Dhruvil Vyas on 7/21/22.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        let requestError = NSError(domain: "NSError", code: 0, userInfo: nil)
    ...
    func test_getFromURL_succeedsWithEmptyDataOnHTTPURLResponseWithNilData() {
        ...
        let receivedResponse = resultValuesFor(data: nil, response: response, error: nil)
